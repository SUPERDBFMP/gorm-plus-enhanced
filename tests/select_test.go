...
func TestSelectByIdName(t *testing.T) {
	...
	gplus.SelectById[User](ctx, 1, gplus.Db(sessionDb))
}
...
func TestSelectByIdSelect(t *testing.T) {
	...
	gplus.SelectById[User](ctx, 1, gplus.Db(sessionDb), gplus.Select(&u.Username, &u.Age))
}
...
func TestSelectByIdOmit(t *testing.T) {
	...
	sessionDb := checkSelectSql(t, expectSql)
	u := gplus.GetModel[User]()
	gplus.SelectById[User](ctx, 1, gplus.Db(sessionDb), gplus.Omit(&u.Username, &u.Age))
}
...
func TestSelectByIdsIn(t *testing.T) {
	...
	sessionDb := checkSelectSql(t, expectSql)
	gplus.SelectByIds[User](ctx, []int{1, 2}, gplus.Db(sessionDb))
}
...
func TestSelectOneName(t *testing.T) {
	...
	gplus.SelectOne[User](ctx, query, gplus.Db(sessionDb))
}
...
func TestSelectListEq(t *testing.T) {
	...
	query, u := gplus.NewQuery[User]()
	query.Eq(&u.Username, "afumu")
	gplus.SelectList[User](ctx, query, gplus.Db(sessionDb))
}
...
func TestSelectListQueryModel(t *testing.T) {
	...
	gplus.SelectGeneric[User, []UserVo](ctx, query, gplus.Db(sessionDb))
}
